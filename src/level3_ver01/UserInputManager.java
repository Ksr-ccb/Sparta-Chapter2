...
public class UserInputManager {
    ...
    /// /////////////////////////////////////////////////////////////////////////////////////////////////////////////
    void inputValue(ArithmeticCalculator calculator) {
    ...
    /// ////////////////////////////////////////////////////////////////////////////////////////////////////////////
    boolean handleSavedResult(RecordController recordController) {
    ...
    void customSortingRecord(RecordController recordController){
    ...
    void editDeleteRecord(int index, RecordController recordController){
        ...
        if(totalStr.matches("\\d+")){ //int값이면
            ...
            handleSavedResult(recordController);
        }else {
            System.out.println("유효하지 않은 입력이에요.");
            System.out.println("/////////////////////////////////////");
        }
    }
    void pickHandleRecord(RecordController recordController){
        ...
        if(totalStr.matches("\\d+")){ //int값이면
            try{
                ...
                editDeleteRecord(index, recordController);
            }catch (Exception e){
                System.out.println("누적 결과값을 불러올 수 없어요");
                System.out.println("에러 메시지 : " + e.getMessage());
            }
    ...
    /// ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    boolean selectService(RecordController recordController) {
        System.out.println("////////////////////////////////////// \n");
